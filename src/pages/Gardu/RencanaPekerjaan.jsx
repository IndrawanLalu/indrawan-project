...
const RencanaPekerjaan = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const q = query(
          collection(db, "rencanaKerjaGardu"), // Sesuaikan nama koleksi
          where("tanggalRencana", ">=", format(startDate, "yyyy-MM-dd")),
          where("tanggalRencana", "<=", format(endDate, "yyyy-MM-dd"))
        );
        ...
        const sortedData = dataGangguan.sort(
          (a, b) => new Date(b.tanggalRencana) - new Date(a.tanggalRencana)
        );
        setData(sortedData);
      } catch (error) {
      ...
      <div className="w-full text-center mx-auto px-4">
        <div className="flex flex-col">
          ...
          <div className="flex gap-4 items-center">
            ...
            <Link to="/admin/gardu/tambah-pemeliharaan-gardu">
...
export default RencanaPekerjaan;
